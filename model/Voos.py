...
class Voos:
    ...
    def __init__(self, cod:str, aeronave:Aeronaves, assentos:dict, origem:str, destino:str, data:datetime,horario_decolagem:str, pilotos:Pilotos, aeromocas:Aeromocas):
